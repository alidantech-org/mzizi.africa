...
export default function Footer() {
  return (
    <footer id="about" className="bg-background py-6 text-foreground border-t border-border">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        {/* Company Info */}
        <div className="col-span-1 md:col-span-2">
          <div className="flex items-center space-x-3 mb-4">
            <h1 className="text-2xl font-bold">PRFI</h1>
          </div>
          <p className="text-muted-foreground leading-relaxed max-w-md">
            Leading platform for monitoring political donations, detecting suspicious financial activity, and promoting transparency in
            campaign financing across the nation.
          </p>
      ...
      <div className="mt-12 pt-8 border-t border-border">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">&copy; 2025 Polifin. All rights reserved.</p>
