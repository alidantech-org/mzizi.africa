"""
Geo Units Repository - Database operations for geographic units
"""
...
class GeoUnitsRepository:
    """Repository for geographic units database operations"""
    ...
    async def search(self, query: Dict[str, Any]) -> List[Dict[str, Any]]:
        """Search geographic units with comprehensive filtering"""
        # Set model to GeoUnits
        query["model"] = GeoUnits
        ...
        return GeoResponseBuilder.build_geo_unit_list(units, include_details)
...
def get_geo_units_repository() -> GeoUnitsRepository:
    """Get GeoUnits repository instance."""
    db = next(get_db())
    return GeoUnitsRepository(db)
